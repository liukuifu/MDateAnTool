<%@ Page Language="C#" AutoEventWireup="true" CodeFile="channelwf.aspx.cs" Inherits="MdataAn.channelwf" %>
		...
		<div class="col-md-2">
            <div class="container">
			 <select class="form-control" runat="server" id="ctype" name="ctype" style="width:auto;display:inline" onchange="chg(this.value);"> 
                ...
                <label for="dtp_input2" class="control-label" style="display: inline">渠道号 ： </label>
                <asp:TextBox class="form-control" ID="tbChannel" name="tbChannel" runat="server" style="width:60px;display: inline"></asp:TextBox>
            ...
            <div style="vertical-align:central;text-align:center;padding-left:50px">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="daychcount" HeaderText="DAU channel 用户数" >
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="daychcountp" HeaderText="DAU channel 用户比例" >
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="new" HeaderText="DNU channel 用户数" >
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="secondnew" HeaderText="次日访问数" >
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="secondnewp" HeaderText="次日留存比例" >
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="thirdnew" HeaderText="第三日访问数" >
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="thirdnewp" HeaderText="第三日留存比例" >
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="threenew" HeaderText="三日访问数" >
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="threenewp" HeaderText="三日留存比例" >
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                        </asp:BoundField>
                    </Columns>
